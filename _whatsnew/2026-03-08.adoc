...
https://docs.netapp.com/us-en/workload-vmware/launch-migration-advisor-gcve.html[Create a deployment plan for Google Cloud VMware Engine using the migration advisor]
