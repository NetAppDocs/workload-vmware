...
https://www.dell.com/en-us/shop/vmware/sl/rvtools[Learn more about RVTools^]

.Steps

. Download and install RVTools 4.4.2 or greater from https://www.dell.com/en-us/shop/vmware/sl/rvtools[RVTools website^]
...
+
See the chapter on "commandline parameters" in the https://www.dell.com/en-us/shop/vmware/sl/rvtools[RVTools documentation^] for details.
...
+
The planning center is displayed. From the planning center, you can upload your VM inventory data, see previous inventory data uploads, and plan a migration using any of the VM inventory datasets. and then select *Migration to AWS native compute*. The VMware migration advisor splash screen is displayed.
+
