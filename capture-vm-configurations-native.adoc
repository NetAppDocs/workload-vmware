...
+
From the planning center, you can upload your VM inventory data, see previous inventory data uploads, and plan a migration using any of the VM inventory datasets. and then select *Migration to AWS native compute*. The VMware migration advisor splash screen is displayed.
+
