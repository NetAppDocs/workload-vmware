...
. In the VMware tile, click *Plan and deploy*.
+
...
. Select *Create a new deployment plan*, select the option for *Use the migration advisor VMware data collector*, and click *Next*.
+
