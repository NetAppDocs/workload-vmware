...
. From the VMware menu, select *Assess and plan* and then select *Migration to VMware Cloud on AWS*.
+
The VMware migration advisor main page is displayed.

. Select *Plan and create VMC*.
. Select *Let's start!*. You can choose to not show this page again by selecting the checkbox.
...
. Download and install RVTools 4.4.2 or greater in the https://www.dell.com/en-us/shop/vmware/sl/rvtools[RVTools website^]
...
+
See the chapter on "commandline parameters" in the https://www.dell.com/en-us/shop/vmware/sl/rvtools[RVTools documentation in the Resources section^] for details.
