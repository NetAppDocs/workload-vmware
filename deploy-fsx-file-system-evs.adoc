...
+
.. *Datastore mount options*: Optionally, enable the *Mount datastores to EVS cluster* option to change VMware ESXi host settings so that datastores are mounted to the Amazon EVS cluster. 
