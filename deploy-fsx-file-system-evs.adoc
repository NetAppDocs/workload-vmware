...
+
If Amazon EVS is not available in this region, or if your account doesn't have permissions to retrieve the secret ARN in this region, you can manually enter a secret ARN value.
