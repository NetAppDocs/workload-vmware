...
== View EVS environment Well-Architected insights

For discovered EVS virtualization environments, Workload Factory automatically performs daily well-architected scans to identify potential configuration issues and provide remediation guidance.
...
+
The planning center is displayed.
. Navigate to your EVS environment details.
. Select the *Well architected status* tab to view insights and recommendations.
+
The Well-Architected Dashboard displays the last scan timestamp and any configuration issues found.
. To view detailed findings for a topic, select *View* on the topic card.
+
A dialog displays the findings summary, impacted resources grid, action required, and recommendations.

For more information, refer to link:view-evs-well-architected.html[View Well-Architected Dashboard for EVS environments].
