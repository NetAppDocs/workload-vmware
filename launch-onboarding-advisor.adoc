...
. From the VMware workloads tile, select *Plan and deploy* and the VMware migration advisor main page is displayed.
+
...
* Select *Deploy* to deploy the FSx for ONTAP file systems to support your VMs. link:deploy-fsx-file-system.html[Learn how to deploy an FSx for ONTAP system].
