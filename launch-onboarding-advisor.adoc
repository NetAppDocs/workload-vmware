...
* <<Create a deployment plan based on an existing deployment plan,To deploy a system in the cloud based on an existing deployment plan that has similar requirements.>>
...
+
The top of the page provides an overview of the hosts, VMs, and capacity required for the VMs that you are migrating.
+
The bottom of the page lists all the VM that will be included in the migration.
. Select the VMs that you want to onboard/migrate from the VMs on this page. By clicking the checkbox in the heading row you can select all VMs on this page.
...
* Click *Deploy* to deploy the FSx for ONTAP file systems to support your VMs.
...
== Create a deployment plan based on an existing deployment plan
