...
. Click *Next* and the "VMware cloud on AWS node configuration" page is displayed. This page enables you to define the VMware cloud on AWS cluster configuration.
