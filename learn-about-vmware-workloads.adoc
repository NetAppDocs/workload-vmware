...
The dashboard performs automatic scans using AWS APIs without requiring vSphere credentials, and presents findings organized by category, subcategory, and topic. Each finding includes severity levels, impacted resource details, and step-by-step remediation procedures.
