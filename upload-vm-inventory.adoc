...
in the https://www.dell.com/en-us/shop/vmware/sl/rvtools[Learn more about RVTools^]
...
. Download and install RVTools 4.4.2 or greater from the https://www.dell.com/en-us/shop/vmware/sl/rvtools[RVTools website^]
...
+
See the chapter on "commandline parameters" in the https://www.dell.com/en-us/shop/vmware/sl/rvtools[RVTools documentation located in the Resources section^] for details.
...
* link:launch-migration-advisor-evs.html[Create an Amazon Elastic VMware Service deployment plan]
* link:launch-onboarding-advisor-native.html[Create an Amazon EC2 deployment plan]
* link:launch-migration-advisor-gcve.html[Create a Google Cloud VMware Engine deployment plan]