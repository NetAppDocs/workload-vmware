...
[.lead]
Using configuration analysis insights and recommendations, leverage Workload Factory to implement best practices for your Amazon Elastic VMware Service (EVS) environments. You can easily review the well-architected status, learn about issues with your configurations, take action to improve the architecture of any systems that aren't optimized for reliability, security, efficiency, performance, and cost.
